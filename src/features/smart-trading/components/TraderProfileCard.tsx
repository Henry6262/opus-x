...
export function TraderProfileCard({
  ...
  return (
    <div className="relative mt-0 md:mt-0 pt-0 md:pt-1 pb-3 md:pb-2 overflow-hidden md:overflow-visible">
      ...
      {/* Main pill container */}
      <div className="relative mt-3 md:mt-4 rounded-full bg-black/50 backdrop-blur-xl border-2 border-[#c4f70e]/30 h-12 md:h-16 ml-10 md:ml-20 w-fit max-w-[700px] overflow-visible flex items-center shadow-[0_0_20px_rgba(196,247,14,0.1)] animate-[profile-ambient-breathing_3s_ease-in-out_infinite] z-[20]">
          {/* Subtle glow effects */}
