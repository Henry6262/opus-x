...
- 2026-01-16: Portfolio Wallet positions now show SOL values based on entry cost plus unrealized PnL.
- 2026-01-16: Portfolio Wallet positions tab is hidden for now.
